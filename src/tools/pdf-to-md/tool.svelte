    ...
    <div class="flex flex-col gap-2">
      ...
      {:else}
        <textarea
          ...
          spellcheck="false"
          class="min-h-105 w-full resize-y rounded-lg border border-border bg-card p-4 font-mono text-[13px] leading-relaxed text-foreground shadow-xs outline-none focus-visible:border-primary/40 focus-visible:ring-2 focus-visible:ring-ring/30"
        ></textarea>
      {/if}
    </div>
