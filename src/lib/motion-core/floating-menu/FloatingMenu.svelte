<script lang="ts">
	...
	interface Props {
		...
		logo?: Snippet;
		/**
		 * Snippet for additional header action items, rendered before the primary/secondary buttons.
		 */
		actions?: Snippet;
		/**
...
>
	...
	>
		...
		>
			...
			<span
				class="ml-1 hidden text-sm font-medium text-foreground transition-[color] duration-400 ease-[cubic-bezier(0.625,0.05,0,1)] group-hover:text-primary sm:inline"
			>
				Menu
			</span>
		</button>
