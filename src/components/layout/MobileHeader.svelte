...
<header
  class="sticky top-0 z-50 flex w-full flex-col border-b border-border bg-card/70 backdrop-blur-lg backdrop-saturate-150 supports-backdrop-filter:bg-card/55 md:hidden"
